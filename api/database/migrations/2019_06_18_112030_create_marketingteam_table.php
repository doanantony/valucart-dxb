...
class CreateMarketingteamTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('marketingteam', function (Blueprint $table) {
            $table->mediumIncrements('id');
            $table->unsignedSmallInteger('user_type_id')->nullable(false)->default('3');
    ...
    {
        Schema::dropIfExists('marketingteam');
    }
}
