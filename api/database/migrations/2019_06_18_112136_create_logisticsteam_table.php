...
class CreateLogisticsteamTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('logisticsteam', function (Blueprint $table) {
            $table->mediumIncrements('id');
            $table->unsignedSmallInteger('user_type_id')->nullable(false)->default('4');
    ...
    {
        Schema::dropIfExists('logisticsteam');
    }
}
