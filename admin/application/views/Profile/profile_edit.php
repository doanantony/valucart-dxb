        ...
        <div class="col-md-6">
          ...
          <!-- form start -->
           ...
           <div class="box-body box-profile">                
            ...
            <?php if($profile_pic->profile_pic != NULL){ ?>
             <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url().$profile_pic->profile_pic; ?>" alt="User profile picture">          
            <?php }else{ ?>
