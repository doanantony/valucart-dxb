                    ...
                    <div class="col-md-8">
                      <div class="table-responsive">
                        <table class="table table-bordered">
                          <thead>
                            <tr>
                            <th colspan="4"> Items<span style="float: right;"><button class="btn btn-info" type="button" id="add_item">ADD ITEM</button></span>
      ...
      $("#add_prod").on('click', function(){
        ...
        if(bundle_item.length > 0){
          var ids = JSON.stringify(bundle_item);
           $.ajax({
            type: "POST",
            url: '<?php echo base_url('Placeorder/get_products'); ?>',
            data: 'ids='+ids,
