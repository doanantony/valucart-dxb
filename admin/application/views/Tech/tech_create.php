...
-->
                        ...
                        <div class="col-md-6">
                           ...
                           <div class="form-group has-feedback">
                              ...
                              <input type="text" class="form-control required" data-parsley-trigger="keyup" data-parsley-type="digits" data-parsley-minlength="10" data-parsley-maxlength="50" data-parsley-pattern="^[0-9]+$" required="" name="phone_no"  placeholder="Enter Phone" value="<?php echo $result->phone_no; ?>" onblur="phone_availability($(this),<?php echo $id; ?>)">
                            <span class="glyphicon  form-control-feedback"></span>
