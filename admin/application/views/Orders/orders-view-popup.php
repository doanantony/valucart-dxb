...
<title>Order confirmation - Reference: Vc0001</title>
<style>
...
<body>
    ...
    <div class="container">
        ...
        <div class="">
            ...
            <div class="identity-container" style="float: left;padding-left: 23px;
">
                 ...
                 <div class="valucart-contact">
                    ...
                    <h1>INVOICE</h1>
                    <div class="">Order Date: <?php echo $data['data']['created_at'] ?></div>
                    <div class="data-wrapper">Order Reference: <?php echo $data['data']['reference'] ?></div>
                    <div class="data-wrapper">Invoice No: <?php echo $data['data']['reference'] ?></div>
                    <div class="data-wrapper">TRN: 100546479500003</div>
            ...
            <div class="identity-container" style="float: right;padding-right: 83px;">
                 <div class="valucart-contact">
                    
                    <h2>Customer Info</h2>
                    <div class="">Name : <?php echo  $data['data']['customer']['name'] ?></div>
                    <div class="data-wrapper">Email: <?php echo  $data['data']['customer']['email'] ?></div>
                    <div class="data-wrapper">Phone No: <?php echo  $data['data']['customer']['phone_number'] ?></div>
                    <div class="data-wrapper">Adress:  <?php echo $data['data']['delivery_information']['address'] ?></div>
                    <div class="data-wrapper">Delivery date/time: <?php echo $data['data']['delivery_information']['date'] ?>, <?php echo $data['data']['delivery_information']['time'] ?></div>
        ...
        <?php
         ...
         if(count($data['data']['bundles'] || $data['data']['customer_bundles'] ) > 0){
        ?>
                ...
                <div class="bundle-header" >
                    ...
                    <div class="meta-data">
                        ...
                        <div class="data-wrapper">
                            ...
                            <div class="value"><?php echo $bundle['quantity'] ?></div>
                        </div>
                        ...
                        <div class="data-wrapper">
                            ...
                            <div class="value"><?php echo $bundle['price'] ?> * <?php echo $bundle['quantity'] ?></div>
                        </div>
                ...
                <div class="bundle-header" >
                    ...
                    <div class="meta-data">
                        ...
                        <div class="data-wrapper">
                            ...
                            <div class="value"><?php echo $bundle['price'] * $bundle['quantity'] ?></div>
                        </div>
        ...
        <div class="payment-information" >
            ...
            <div class="right">
                ...
                <table class="payment-information-table" >
                    ...
                    <tbody class="styled">
                        <tr>
                            <td>Sub total:</td>
                            <td><?php echo $data['data']['sub_total'] ?></td>
                        </tr>

                        <tr>
                            <td>Discount:</td>
                            <td><?php echo $data['data']['discount'] ?></td>
                        </tr>
                    ...
                    <tfoot>
                        <tr>
                            <td>TOTAL:</td>
                            <td><?php echo $data['data']['total'] ?></td>
                        </tr>
                    </tfoot>
            ...
            <div class="left">
                ...
                <div class="payment-information">
                    ...
                    <div class="info">
                        <div class="label" style="color:#696969;font-size: 15px;">Payment type:<?php echo $order->payment_type; ?></div>
                        <div class="value" ></div>
                        <div style="clear: both;" ></div>
                    </div>
