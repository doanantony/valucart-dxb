...
class Marketing extends CI_Controller
{
    ...
    public function index() {
        ...
        $template['page'] = 'Marketing/marketing_view';
        $template['page_title'] = "View Marketing";
        $template['page_data'] = $this->info;
        $template['data'] = $this->Marketing_model->get_marketing();
    ...
    public function create() {
        ...
        $template['page'] = 'Marketing/marketing_create';
        ...
        if($_POST) {
            ...
            $result = $this->Marketing_model->save_marketing($data,$object_id);
    ...
    public function edit($id=null) {
        ...
        $template['sub'] = $this->info->function_menu;
        $template['page'] = 'Marketing/marketing_create';
        $template['page_title'] = "Edit Marketing";
        $template['page_data'] = $this->info;
        $query = $this->db->where('id',$id)->get('marketingteam')->row();
        ...
        $template['result'] = $this->Marketing_model->get_single_marketing($id);
        ...
        if($_POST) {
            $data = $_POST;
            $object_id =  $this->info->object_id;
            $result = $this->Marketing_model->update_marketing($data,$id,$object_id);
            if($result == "Exist") {
                $this->session->set_flashdata('message', array('message' => 'Member already exist','class' => 'danger'));
            }
            else {
